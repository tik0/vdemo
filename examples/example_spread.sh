...
spreaddaemon,             $host01,            -t spread -L 1  -g sleepers -w 0 -W 1 -x:
spreaddaemon,             $host02,            -t spread -L 1  -g sleepers -w 0 -W 1 -x:
spreaddaemon,             $host03,            -t spread -L 1  -g sleepers -w 0 -W 1 -x:
"
