...
Tab1:
sleep,             $host01,            -t sleep01-01  -L 1  -g sleepers -W 1:
sleep,             $host01,            -t sleep01-01  -L 1  -g sleepers -W 1:
sleep,             $host02,            -t sleep01-02  -L 1  -g sleepers -W 1:
sleep,             $host02,            -t sleep-x     -L 1  -g sleepers -W 1 -x:
...
faildelayed,       $host05,            -t sleep04-05B -L 4  -g sleepers09 -W 1:
